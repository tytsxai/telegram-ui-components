...
import { KeyboardButton, KeyboardRow, Screen } from "@/types/telegram";
...
const TelegramChat = () => {
  ...
  const saveScreen = () => {
    ...
    const screen: Screen = { id, name, message_content: messageContent, keyboard };
  ...
  const loadScreen = (id: string) => {
    ...
    if (!s) return;
    setMessageContent(s.message_content);
